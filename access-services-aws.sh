...
get_port_forward_cmd() {
    case $1 in
        ...
        "kibana") echo "kubectl port-forward -n default svc/kibana 5601:5601" ;;
        "elasticsearch") echo "kubectl port-forward -n default svc/elasticsearch 9200:9200" ;;
        "rabbitmq") echo "kubectl port-forward -n default svc/rabbitmq 15672:15672" ;;
        "pgadmin") echo "kubectl port-forward -n default svc/pgadmin 5050:80" ;;
        "portainer") echo "kubectl port-forward -n default svc/portainer 9000:9000" ;;
        "api-gateway") echo "kubectl port-forward -n default svc/ocelotapigw 8010:80" ;;
        "catalog-api") echo "kubectl port-forward -n default svc/catalogapi 8001:80" ;;
        "basket-api") echo "kubectl port-forward -n default svc/basketapi 8002:80" ;;
        "discount-api") echo "kubectl port-forward -n default svc/discountapi 8003:80" ;;
        "ordering-api") echo "kubectl port-forward -n default svc/orderingapi 8004:80" ;;
