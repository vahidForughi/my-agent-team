...
export class DiscountService {
  ...
  enrichProductWithDiscount(product: IProduct): Observable<IProductWithDiscount> {
  ...
  enrichProductsWithDiscounts(products: IProduct[]): Observable<IProductWithDiscount[]> {
