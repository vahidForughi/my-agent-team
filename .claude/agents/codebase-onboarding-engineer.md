...
model: inherit
description: Use to understand an unfamiliar codebase fast — repo structure, entry points, execution paths, module boundaries, and data flows. Read-only; states only facts grounded in inspected source code.
---
