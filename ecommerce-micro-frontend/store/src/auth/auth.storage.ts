/**
 * Store Module - Authentication Storage
 */
...
export class AuthStorage {
  ...
  static getUser(): User | null {
    ...
    try {
      ...
      console.error('[store/auth] Failed to parse user from storage:', error);
      return null;
    }
  }
  ...
  static setUser(user: User): void {
    ...
    try {
      ...
      console.error('[store/auth] Failed to save user to storage:', error);
    }
  }
